...
public class Main{
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Veiculo veic1 = new Veiculo("ADJSA23", "Corsa", "Rebaixado", 2012);
        Veiculo veic2 = new Veiculo("VAICORIN", "Saveiro", "Cromada", 2015);
        Date date = new GregorianCalendar(2003, Calendar.JUNE, 18).getTime();

        Cliente_PF clPF = new Cliente_PF("Renan", new Date(), "Casa", "Pouca", "Masculino", "Pobre", "45959165821", date);
        date = new GregorianCalendar(1910, Calendar.SEPTEMBER, 1).getTime();
        Cliente_PJ clPJ = new Cliente_PJ("Corintia", "SerieB", "61902722000126", date, 100);
        ...
        System.out.println("Valores dos seguros antes de adicionar os carros:");
        System.out.println(clPF.getValorSeguro());
        System.out.println(clPJ.getValorSeguro());

        clPF.adicionarVeiculo(veic1);
        clPJ.adicionarVeiculo(veic2);

        System.out.println("Valores dos seguros depois de adicionar os carros:");
        System.out.println(clPF.getValorSeguro());
        System.out.println(clPJ.getValorSeguro());

        date = new GregorianCalendar(2020, Calendar.SEPTEMBER, 1).getTime();
        seg.gerarSinistro(date, "esquina do bar", veic1, seg, clPF);

        date = new GregorianCalendar(2020, Calendar.SEPTEMBER, 1).getTime();
        seg.gerarSinistro(date, "morumbi", veic2, seg, clPJ);

        System.out.println(seg.listarClientes("Cliente_PF"));
        System.out.println(seg.visualizarSinistro("Renan"));
    ...
    public static boolean realizarOperacao(SubMenu operacao, ArrayList<Seguradora> listaSeguradoras) throws ParseException{
        ...
        switch (operacao){
            ...
            case EXCLUIR_CLIENTE:
                ...
                return seg.removerCliente(cliente);
